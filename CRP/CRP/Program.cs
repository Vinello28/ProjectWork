...
var connectionStringCL = builder.Configuration.GetConnectionString("ClConnection") ?? throw new InvalidOperationException("Connection string 'ClmanagerContext' not found.");
